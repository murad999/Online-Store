                            ...
                            @foreach(Cart::content() as $product)
                                <tr class="cart_item">
                                    ...
                                    <td class="product-quantity">
                                        ...
                                        <div class="quantity">
                                            <a href="{{route('cart.derc',['id'=>$product->rowId,'qty'=>$product->qty])}}" class="quantity-minus">-</a>
                                            <input title="Qty" class="email input-text qty text" type="text" placeholder="1" value="{{$product->qty}}" readonly>
                                            <a href="{{route('cart.inrc',['id'=>$product->rowId,'qty'=>$product->qty])}}" class="quantity-plus">+</a>
                                        </div>
